...
from pyseis_io.javaseis.xml_io import JavaSeisXML
from pyseis_io.javaseis.templates import *  # Import all templates
from pyseis_io.javaseis.templates import FilePropertiesTemplate, VirtualFoldersTemplate, TraceHeadersTemplate, TraceFileTemplate
from pyseis_io.javaseis.js_models import build_header_struct, build_trace_struct
class ExtentManager:
